...
from bitpoint.activities.models import Activity, Notification
from bitpoint.articles.models import Article
from bitpoint.feeds.models import Feed
from bitpoint.questions.models import Question, Answer
from bitpoint.authentication.models import Profile
...
class TestModels(TestCase):
    ...
    def test_register_like_notification(self):
        ...
        test_string = notification._LIKED_TEMPLATE.format(
            self.user.ID_Number, self.user.profile.get_screen_name(),
